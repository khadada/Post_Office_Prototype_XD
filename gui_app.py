...
total_amount_show = Label(master,bg=bgc,text="0.0")
total_amount_show.grid(row=1,column=4) 
Label(master,bg=bgc,text=":الملبغ المتبقي").grid(row=0,column=0)
remaining_amount_show = Label(master,bg=bgc,text="0.0")
remaining_amount_show.grid(row=1,column=0)
Label(master,bg=bgc,text='مرحبا بك يا خديجة في برنامجك',pady=20).grid(row=2,column=1,columnspan=3)
